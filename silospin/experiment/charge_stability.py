...
class ChargeStabilitySweepsSerialMultiInstrument:
    def __init__(self, dac_id="COM3", mfli_ids={"dev5759"}, excluded_zurich_devices= ["dev8446", "dev5761"], filter_tc=10e-3):
        ...
        for inst in mfli_ids:
            excluded_zurich_devices = all_excluded - {inst}
            self._mfli[inst] = MfliDriverChargeStability(excluded_devices = excluded_zurich_devices, timeconstant=filter_tc)
