...
def do1DSweep(parameter, start_value, end_value, npoints, n_r = 10, n_fr = 1, plot = True, lockins = {1,2,3}, filter_tc=10e-3, dac_mapping_file_path = 'C:\\Users\\Sigillito Lab\\Desktop\\experimental_workspaces\\quantum_dot_workspace_bluefors1\\experiment_parameters\\bluefors1_dac.pickle'):
    ...
    self._mflis = {0: MfliDriverChargeStability(excluded_devices=["dev5761", "dev8446", "dev8485", "dev6573"], timeconstant=filter_tc), 1: MfliDriverChargeStability(excluded_devices=["dev5759", "dev8446", "dev8485", "dev6573"], 2: MfliDriverChargeStability(excluded_devices=["dev5759", "dev8446", "dev8485", "dev5761"], timeconstant=filter_tc)}
    ...
    elif lockins == {1,2} or lockins == {2,3}:

    elif lockins == {1} or lockins == {2} or lockins == {3}:
...
#def do1DSweep(parameter, start_value, end_value, lockins = {1,2,3}, client_address = ):
