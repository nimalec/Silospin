            ...
            for i in range(n_fr):
                 ...
                 for j in range(len(V_x_f)):
                     if j == 0:
                         ...
                         img1 = ax1.imshow(V_out1, extent=[end_value1,start_value1,end_value2,start_value2])
                         ...
                         #img2 = ax2.imshow(V_out2, extent=[start_value1,end_value1,start_value2,end_value2])
                         img2 = ax2.imshow(V_out2, extent=[end_value1,start_value1,end_value2,start_value2])
