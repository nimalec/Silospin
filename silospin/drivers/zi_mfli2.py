...
class MFLI2:
    def __init__(self, dev_id, server_host = "localhost", server_port = 8004, sigins = None, dmods = None, oscs = None, sigouts = None, trig_settings = None):
        """
        ...
        self._connection_settings = {"hdawg_id" : dev_id, "server_host" : server_host , "server_port" : server_port, "api_level" : api_level, "connection_status" : False}
