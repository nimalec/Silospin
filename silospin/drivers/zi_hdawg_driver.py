...
class HdawgDriver:
    ...
    def __init__(self, dev_id, name = "hdawg_1", server_host = "localhost", server_port = 8004, api_level = 6, interface = "1GbE"):
      ...
      #  '''
        ...
        self._sequencers = {"awg1" : {"positions" : self._awgs["awg1"].sequencer.pc, "status" :self._awgs["awg1"].sequencer.status , "memoryusage" : self._awgs["awg1"].sequencer.memoryusage, "triggered" : self._awgs["awg1"].sequencer.triggered, "program" :  self._awgs["awg1"].sequencer.program}, "awg2" : {"positions" : self._awgs["awg2"].sequencer.pc, "status" :self._awgs["awg2"].sequencer.status , "memoryusage" : self._awgs["awg2"].sequencer.memoryusage, "triggered" : self._awgs["awg2"].sequencer.triggered, "program" :  self._awgs["awg2"].sequencer.program}, "awg3" : {"positions" : self._awgs["awg3"].sequencer.pc, "status" :self._awgs["awg3"].sequencer.status , "memoryusage" : self._awgs["awg3"].sequencer.memoryusage, "triggered" : self._awgs["awg3"].sequencer.triggered, "program" :  self._awgs["awg3"].sequencer.program}, "awg4" : {"positions" : self._awgs["awg4"].sequencer.pc, "status" :self._awgs["awg4"].sequencer.status , "memoryusage" : self._awgs["awg4"].sequencer.memoryusage, "triggered" : self._awgs["awg4"].sequencer.triggered, "program" :  self._awgs["awg4"].sequencer.program}, "awg5" : {"positions" : self._awgs["awg5"].sequencer.pc, "status" :self._awgs["awg5"].sequencer.status , "memoryusage" : self._awgs["awg5"].sequencer.memoryusage, "triggered" : self._awgs["awg5"].sequencer.triggered, "program" :  self._awgs["awg5"].sequencer.program}, "awg6" : {"positions" : self._awgs["awg6"].sequencer.pc, "status" :self._awgs["awg6"].sequencer.status , "memoryusage" : self._awgs["awg6"].sequencer.memoryusage, "triggered" : self._awgs["awg6"].sequencer.triggered, "program" :  self._awgs["awg6"].sequencer.program}, "awg7" : {"positions" : self._awgs["awg7"].sequencer.pc, "status" :self._awgs["awg7"].sequencer.status , "memoryusage" : self._awgs["awg7"].sequencer.memoryusage, "triggered" : self._awgs["awg7"].sequencer.triggered, "program" :  self._awgs["awg7"].sequencer.program}, "awg8" : {"positions" : self._awgs["awg8"].sequencer.pc, "status" :self._awgs["awg8"].sequencer.status , "memoryusage" : self._awgs["awg8"].sequencer.memoryusage, "triggered" : self._awgs["awg8"].sequencer.triggered, "program" :  self._awgs["awg8"].sequencer.program} }
