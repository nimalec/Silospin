...
from silospin.quantum_compiler.quantum_compiler_helpers import obtain_waveform_arbitrary_gate_waveform

def gst_file_parser(file_path, qubit_lengths, channel_mapping, awg_core_split, sample_rate = 2.4e9, arbgate_picklefile_location = 'C:\\Users\\Sigillito Lab\\Desktop\\experimental_workspaces\\quantum_dot_workspace_bluefors1\\experiment_parameters\\bluefors1_arb_gates.pickle'):
    '''
    ...
    ##Separate into Z and non-Z gates
            ...
            for item in notz_set:
              ...
              ##Checks if  gate is arb
                    ...
                    waveform = obtain_waveform_arbitrary_gate_waveform(gt_label, tau_val, amp, param_values, arbgate_picklefile_location)
