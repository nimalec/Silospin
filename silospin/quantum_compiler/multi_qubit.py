...
class MultiQubitGST:
    def __init__(self, gst_file_path, awg, qubits = {1,2,3,4}):
        ...
        for i in self._awg_cores:
            command_table = generate_reduced_command_table_v2(gts_0, npoints_wait = n_waits, npoints_plunger = None, delta_iq = self._qubit_parameters[str(i)]["delta_iq"], phi_z = 0)
