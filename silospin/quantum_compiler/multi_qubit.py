...
from silospin.io.qc_io import read_qubit_paramater_file, write_qubit_parameter_file, quantum_protocol_parser, gst_parser
...
class MultiQubitGST_v2:
    def __init__(self, gst_file_path, awg, qubits = [0,1,2,3]):
        ...
        3: {"i_amp_pi": 0.5, "q_amp_pi": 0.5 , "i_amp_pi_2": 0.5, "q_amp_pi_2": 0.5, "tau_pi" : 150e-9,  "tau_pi_2" :  75e-9,  "delta_iq" : 0 , "mod_freq": 60e6}}
